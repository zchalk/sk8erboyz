...
function checkStorage() {
    if (theOne) {
        for (let i = 0; i < theOne.length; i++) {
            ...
            if (theOne[i].contact.email) {
                var contact = "mailto:" + theOne[i].contact.email;
            } else {
                var contact = theOne[i].url;
                }
